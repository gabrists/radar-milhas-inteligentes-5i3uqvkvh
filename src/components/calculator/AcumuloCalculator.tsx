...
export function AcumuloCalculator() {
  const { user } = useAuth()
  ...
  const handleSaveMiles = async () => {
    ...
    try {
      ...
      toast({
        title: 'Sucesso!',
        description: 'Simulação registrada e milhas adicionadas!',
      })
      setProductName('')
      setProductValue('')
    } catch (error) {
      toast({
        ...
        description: 'Ocorreu um erro ao tentar adicionar as milhas.',
        variant: 'destructive',
      })
    } finally {
      setIsSaving(false)
  ...
  const applyPromo = useCallback(
    (bonus: number) => {
      ...
      toast({
        ...
        description: `A calculadora foi ajustada para ${bonus}% de bônus.`,
      })
    },
    [toast],
  )
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className={cn(
                    ...
                    productValue ? 'border-primary/30 ring-primary/10' : '',
                  )}
                />
              </div>
            </div>
              ...
              <div className="relative">
                <Input
                  ...
                  className={cn(
                    ...
                    pointsPerReal ? 'border-primary/30 ring-primary/10' : '',
                  )}
                />
